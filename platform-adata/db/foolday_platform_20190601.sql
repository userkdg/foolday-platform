...
create table if not exists foolday_platform.t_article
(
...
create table if not exists foolday_platform.t_banner
(
    id varchar(36) not null
        primary key,
...
create table if not exists foolday_platform.t_carouse
(
    id varchar(36) not null
        primary key,
    order_no int(5) not null comment '排序',
...
create table if not exists foolday_platform.t_comment
(
    id int not null
        primary key,
...
create table if not exists foolday_platform.t_coupon
(
    id varchar(36) not null
        primary key,
    create_time datetime default CURRENT_TIMESTAMP not null comment '创建时间',
...
create table if not exists foolday_platform.t_coupon_user
(
    id varchar(36) not null
        primary key,
    create_time datetime default CURRENT_TIMESTAMP not null comment '创建时间',
...
create table if not exists foolday_platform.t_goods
(
...
create table if not exists foolday_platform.t_goods_category
(
    id varchar(64) not null
        primary key,
...
create table if not exists foolday_platform.t_goods_spec
(
    id varchar(36) not null
        primary key,
...
create table if not exists foolday_platform.t_groupbuy
(
...
create table if not exists foolday_platform.t_groupbuy_task
(
    id varchar(32) not null
        primary key,
...
create table if not exists foolday_platform.t_image
(
    id varchar(36) not null
        primary key,
...
create table if not exists foolday_platform.t_message
(
    id varchar(36) not null
        primary key,
...
create table if not exists foolday_platform.t_order
(
    id varchar(64) not null
        primary key,
    shop_id varchar(64) not null comment '店铺id',
...
create table if not exists foolday_platform.t_order_detail
(
    id varchar(36) not null
        primary key,
    order_id varchar(36) not null comment '订单id',
...
create table if not exists foolday_platform.t_qrcode
(
    id varchar(32) not null
        primary key,
...
create table if not exists foolday_platform.t_shop
(
    id varchar(32) not null
        primary key,
...
create table if not exists foolday_platform.t_sys_admin
(
    id varchar(36) not null
        primary key,
...
create table if not exists foolday_platform.t_sys_admin_auth
(
    id varchar(36) not null
        primary key,
    user_id varchar(36) not null comment '用户id',
...
create table if not exists foolday_platform.t_sys_admin_menu
(
    id varchar(36) not null
        primary key,
    user_id varchar(36) not null comment '用户id',
...
create table if not exists foolday_platform.t_sys_admin_role
(
    id varchar(36) not null
        primary key,
    user_id varchar(36) not null comment '用户id',
...
create table if not exists foolday_platform.t_sys_auth
(
    id varchar(36) not null,
...
create table if not exists foolday_platform.t_sys_log
(
    id varchar(36) not null
        primary key,
...
create table if not exists foolday_platform.t_sys_menu
(
    id varchar(36) not null
        primary key,
...
create table if not exists foolday_platform.t_sys_role
(
    id varchar(36) not null
        primary key,
...
create table if not exists foolday_platform.t_sys_role_auth
(
    id varchar(36) not null
        primary key,
...
create table if not exists foolday_platform.t_table
(
    id varchar(32) not null
        primary key,
...
create table if not exists foolday_platform.t_tags
(
    id varchar(64) not null
        primary key,
...
create table if not exists foolday_platform.t_user
(
    id varchar(36) not null
        primary key,
...
create table if not exists foolday_platform.t_user_address_history
(
    id varchar(36) not null
        primary key,
...
create table if not exists foolday_platform.t_user_advice
(
    id varchar(36) not null
        primary key,
    create_time datetime default CURRENT_TIMESTAMP not null comment '创建时间',
