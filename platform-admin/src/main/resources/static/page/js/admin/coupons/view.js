    ...
    tableIns = table.render({
        ...
        cols: [
            [
                ...
                {field: 'province', title: '优惠券名称', align: 'center'},
                {field: 'city', title: '可领取时间', align: 'center'},
                {field: 'sequence', title: '使用范围', align: 'center'},
                {field: 'province', title: '优惠券有效期', align: 'center'},
                {field: 'city', title: '领取上限', align: 'center'},
                {field: 'sequence', title: '库存', align: 'center'},
                {field: 'province', title: '可使用店铺', align: 'center'},
                {field: 'city', title: '优惠券类型', align: 'center'},
        ...
        switch (obj.event) {
            case 'add':
                layer.open({
                    type: 2,
                    title: "添加",
                    content: "../../admin/coupons/add.html",
                    resize: false,
                    area: ['600px', '600px']
                });
                break;
