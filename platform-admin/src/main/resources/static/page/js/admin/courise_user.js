...
layui.use(['table', 'layer', "jquery"], function () {
    ...
    table.render({
        elem: '#user_list'
        , url: '/?action=admin.user.user_list'
        ...
        , cols: [[
            ...
            { field: 'commission_grade', width: 120, title: '分销等级' },
            { align: "center", width: 100, title: "合伙人", toolbar: "#is_partner" },
            { align: "center", width: 100, title: '分销商', toolbar: "#is_commission" },
            { align: "center", width: 100, title: '加盟商家', toolbar: "#is_joined" },
        ...
        parseData: function (res) {
            ...
            res.user_list = res.user_list.map(user => {
                user.commission_grade = user.commission_grade.name || "身份异常";
