...
layui.use(['table', 'layer', "upload", "jquery"], function () {
    ...
    $("#advercise_info").submit(function (e) {
        $.ajax({
            url: "/activity/admin/hotal/hotalAderAdd",
            method: "GET",
            data: {
                path: vm.img
            },
    ...
    table.render({
        elem: '#adver_list'
        , url: '/activity/admin/hotal/hotalAdvers'
        ...
        switch (obj.event) {
            case "del":
                layer.open({
                    ...
                    yes: function () {
                        $.ajax({
                            url: "/activity/admin/hotal/hotalAdverDel",
                            method: "GET",
                            data: {
                                id: data._id
                            },
    ...
    form.on("switch(status)", function (obj) {
        ...
        checked = checked ? 1 : 0;
        $.ajax({
            url: "/activity/admin/hotal/hotalAdverState",
            method: "GET",
            data: {
                checked,
                id
