...
layui.use(['table', 'layer', "jquery", "upload", "form", "layedit"], function () {
    ...
    $("#goods_info").submit(function (e) {
        ...
        $.ajax({
            url: "/activity/admin/hotal/touristAdd",
            method: "POST",
            data,
    ...
    form.on("switch(used)", function (obj) {
        ...
        checked = checked ? 1 : 0;
        $.ajax({
            url: "/activity/admin/hotal/touristState",
            method: "GET",
            data: {
                checked,
                id
    ...
    form.on("switch(recommend)", function (obj) {
        ...
        checked = checked ? 1 : 0;
        $.ajax({
            url: "/activity/admin/hotal/touristRecom",
            method: "GET",
            data: {
                checked,
                id
        ...
        switch (obj.event) {
            case "del":
                layer.open({
                    ...
                    yes: function () {
                        $.ajax({
                            url: "/activity/admin/hotal/touristDel",
                            method: "GET",
                            data: {
                                id: data._id
                            },
            ...
            case "edit":
                $.ajax({
                    url: "/activity/admin/hotal/tourDetail",
                    method: "GET",
                    data: {
                        id: data._id
                    },
